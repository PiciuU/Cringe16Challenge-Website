...
export default {
    ...
    fetchData() {
        ...
        .then((response) =>{
            this.data.latestAnswerVideo = response.data.list[0].last_answer_video;
            this.data.latestAnswerThumbnail = response.data.list[0].last_answer_thumbnail;
            this.data.latestAnswerTitle = response.data.list[0].last_answer_title;
            this.data.treeData = JSON.parse(response.data.list[0].nominations);
            this.data.participants = JSON.parse(response.data.list[0].answered);
        })
        .catch((error) => {
            console.log(error);
        })
